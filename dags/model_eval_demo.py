...
UPSTREAM_FILE = os.path.join(
    os.path.dirname(__file__), "..", "data", "model_eval_upstream.csv"
)
...
with DAG(
    ...
    description="AirClaw — GPT-4o vs Nemotron-Super Model Migration Eval",
    ...
    def ingest_eval_results(**kwargs):
        ...
        if not path.exists():
            shutil.copy(path.parent / "model_eval_clean.csv", path)
